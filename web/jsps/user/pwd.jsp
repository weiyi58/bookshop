	...
	<form action="<c:url value='/UserServlet'/>" method="post" target="_top">
		...
		<table>
			...
			<tr>
				...
				<td><input class="input" type="password" name="newLoginpass" id="newpass" value="${user.newpass }""/></td>
			...
			<tr>
				...
				<td><label id="reloginpassError" class="erorr"></label></td>
			</tr>
			<tr>
				<td align="right"></td>
				<td>
					<img id="vCode" src="<c:url value='/VerifyCodeServlet'/>" border="1"/>
					<a href="javascript:_change();">看不清，一张</a>
				</td>
			</tr>
			<tr>
